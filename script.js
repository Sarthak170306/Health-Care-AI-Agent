...
// सामान्य 'Stop Words' जो निदान में मदद नहीं करते हैं
...
// --- NEW FUNCTION: District Status Pill को अपडेट करना ---
...
// --- NEW FUNCTION: Dataset Stats को अपडेट करना ---
...
// --- NEW FUNCTION: UI में समय अपडेट करना ---
...
function findDiseaseByName(input) {
    ...
    // 1. Stop Words हटाएँ ताकि "i am suffering from" जैसे शब्द बाधा न डालें
    const cleanedInput = lowerInput
        .split(/\s+/)
        .filter(word => !stopWords.has(word))
        .join(' '); 
    
    // 2. इस cleaned input को बीमारी के नाम में खोजें 
